...
class GameLoggingService {
    logGameProgress(gameCache, currentGuess, currentFeedback) {
        console.log(`*** Round ${10 - gameCache.guessesRemaining} ***`);
        console.log('---------------');
        console.log(`${gameCache.userId} guessed:`);
        console.log(currentGuess);
        console.log(gameCache.feedbackHistory[gameCache.feedbackHistory.length - 1].response);
...
exports.default = gameLoggingService;
